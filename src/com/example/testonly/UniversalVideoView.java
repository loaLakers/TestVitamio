...
import com.example.testonly.UniversalVideoView.OnStateChangeListener.State;
        ...
        public void surfaceCreated(SurfaceHolder holder) {
            ...
            if (isUseVitamio) {
                ...
                if (mVitamioMediaPlayer != null
                    ...
                    // can playing without buffering, but it may not very
                    // reasonable
...
//            }
        ...
        public boolean onInfo(io.vov.vitamio.MediaPlayer mp, int what, int extra) {
            if (mVitamioOnInfoListener != null) {
                ...
                if (what == io.vov.vitamio.MediaPlayer.MEDIA_INFO_BUFFERING_START) {
                    ...
                    stateChange(State.BUFFERING_END);
                    // set the buffer size to 512k
                    mVitamioMediaPlayer.setBufferSize(512 * 1024);
     ...
     * @param layout
     * @param aspectRatio
     * @param hideController true will hide the media controller
     */
    public void setVideoLayout(int layout, float aspectRatio,
    ...
    private void initializeVitamio() {
        new AsyncTask<Object, Object, Boolean>() {
            ...
            protected Boolean doInBackground(Object... params) {
                ...
                return Vitamio
                        .initialize(mContext, R.raw.libarm);
            }
     ...
     * 
     * @param realHeight The height of this view in px.
     */
    ...
    private void createVitamioMediaPlayer() throws IllegalArgumentException,
        ...
        // don't use setOnInfoListener, it may have some problems when playing
        // live stream. the screen will be black for a while before the picture
        // appears.

        // set this for the first time to 10k so the picture will come soon,
        // after the picture coming we should set it to 1m
        mVitamioMediaPlayer.setBufferSize(10 * 1024);
